...
import { AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, ElementRef, Input, OnDestroy, OnInit, Self, ViewChild } from "@angular/core";
...
@Component({
  ...
  selector: 'fb-cva-text-input',
  templateUrl: './cva-text-input.component.html',
  styleUrls: ['./cva-text-input.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CvaTextInputComponent implements OnInit, AfterViewInit, OnDestroy, ControlValueAccessor {
  
  @Input() public label: string = '';
  @Input() public id: string = '';
  @Input() public name: string = '';
  @Input() public placeholder: string = 'Type here...';
  @Input() public type?: 'text' | 'password' | 'email' | 'number' | 'tel' | 'url' | 'search' | 'date' | 'time' | 'datetime-local' | 'month' | 'week' | 'color';
  ...
  constructor(@Self() private _ngControl: NgControl, @Self() private _elementRef: ElementRef, private _changeDetectorRef: ChangeDetectorRef) {
